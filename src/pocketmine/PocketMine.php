 ...
 *
 * @author Glowstone (Lemdy/Lunarelly)
 * @link vk.com/weany
 *
 */
...
namespace pocketmine {
	...
	$logger->info("Остановка работы Glowstone");

	foreach(ThreadManager::getInstance()->getAll() as $id => $thread){
		$logger->debug("Остановка " . (new \ReflectionClass($thread))->getShortName() . " потока");
		$thread->quit();
	}
	...
	echo "Сервер остановлен!" . Terminal::$FORMAT_RESET . "\n";
